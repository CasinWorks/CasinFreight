        ...
        <div className="relative pl-1 border-l border-slate-200 shrink-0">
          ...
          >
            {currentUser.avatarUrl ? (
              ...
              <span className="w-7 h-7 md:w-8 md:h-8 rounded-full border border-slate-200 bg-slate-100 text-slate-700 text-[11px] font-bold flex items-center justify-center">
              ...
              <div className="absolute right-0 top-full mt-2 w-64 bg-white rounded-2xl border border-slate-200 shadow-xl z-50 p-2 text-xs animate-in zoom-in-95 duration-150">
                ...
                <div className="py-2">
                  <button
                    ...
                    className="w-full p-2 rounded-lg hover:bg-slate-50 text-left text-xs font-semibold text-slate-700 flex items-center gap-2"
                  >
